...
select yn in "Yes" "No"; do
    case $yn in
        Yes ) break;;
        No ) sudo pacman -S --needed git base-devel && git clone https://aur.archlinux.org/yay-bin.git && cd yay-bin && makepkg -si && cd ~ && break;;
    esac
done
...
sudo pacman -S neofetch thunar dunst kvantum waybar wofi pacman-contrib ccache qt6ct qt6-wayland qt5-graphicaleffects qt5-svg qt5-quickcontrols2 zsh kitty pamixer brightnessctl swaybg
